    ...
    def test_checkout(self, driver):
        ...
        with allure.step("Check cart quantity"):
            ...
            if quantity == 0:
                ...
                self.wait_for_element_and_click(driver, BooksPageLocators.ADD_TO_CART)
        ...
        with allure.step("Agree to terms and proceed to checkout"):
            self.wait_for_element_and_click(driver, CheckoutPageLocators.TERMS_OF_SERVICE_CHECKBOX)
            self.wait_for_element_and_click(driver, CheckoutPageLocators.CHECKOUT_BUTTON)

        # Verify the checkout form is displayed
        with allure.step("Verify checkout steps form is displayed"):
            self.wait_for_element(driver,CheckoutPageLocators.CHECKOUT_STEPS_FORM)
