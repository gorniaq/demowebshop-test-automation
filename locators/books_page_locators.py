...
class BooksPageLocators:
    ...
    SORT_BY_POSITION = (By.XPATH, "//option[contains(@value,'books?orderby=0')]")
    SORT_BY_NAME_A_TO_Z = (By.XPATH, "//option[contains(@value,'books?orderby=5')]")
    SORT_BY_NAME_Z_TO_A = (By.XPATH, "//option[contains(@value,'books?orderby=6')]")
    SORT_BY_PRICE_LOW_TO_HIGH = (By.XPATH, "//option[contains(@value,'books?orderby=10')]")
    SORT_BY_PRICE_HIGH_TO_LOW = (By.XPATH, "//option[contains(@value,'books?orderby=11')]")
    SORT_BY_CREATED_ON = (By.XPATH, "//option[contains(@value,'books?orderby=15')]")
    ...
    PAGE_SIZE_OPTION_4 = (By.XPATH, "//option[contains(@value,'/books?pagesize=4')]")
    PAGE_SIZE_OPTION_8 = (By.XPATH, "//option[contains(@value,'/books?pagesize=8')]")
    PAGE_SIZE_OPTION_12 = (By.XPATH, "//option[contains(@value,'/books?pagesize=12')]")
